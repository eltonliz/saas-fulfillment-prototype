...
const VERSIONS = [
  {
    ...
    items: [
      ...
      "发货模式收敛为「供应商直配 / 总部仓发货」两档：总部仓发货新增「货源」选项（供应商供货 / 总部自有），自有货不经供应商、支付后总部直接发货；商品管理支持货源展示、发布配置与免绑供应商",
      "供货单详情新增「收货异常说明」（关联差异单 / 举证 / 处理流程），列表标注实收与差数；业务流程图、场景清单同步新增自营链路与代发售后场景",
    ],
  },
  {
    v: "V1.0",
