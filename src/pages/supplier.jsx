        ...
        <table className="tbl-tight">
          <thead>
            <tr>
              ...
              <th className="tw">供货单号</th><th className="tw col-new w2" data-hl="本次新增">项目</th><th className="tw">关联销售订单</th><th>商品</th>
          ...
          <tbody>
            {pg.pageRows.map((d) => (
              <tr key={d.id}>
                ...
                <td className="tw col-new">{d.project}</td>
    ...
    <>
      ...
      <div className="tbl-wrap">
        <table className="tbl-tight">
          <thead>
            <tr>
              <th className="col-new w2" style={{ minWidth: 96 }} data-hl="本次新增">项目</th>
          ...
          <tbody>
            {pg.pageRows.map((o) => (
              <tr key={o.id}>
                <td className="tw col-new">{o.project}</td>
                <td>
                  <div className="prod-cell">
      ...
      <div className="drawer" style={{ width: 1180 }}>
        ...
        <div className="body" style={{ padding: "18px 22px 30px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
            ...
            <span style={{ marginLeft: "auto", fontSize: 13, color: "#666" }}>所属项目：<b style={{ color: "#333" }}>{order.project}</b><span className="newtag">本次新增</span></span>
          </div>
        ...
        <div className="body">
          <div className="filters" style={{ marginBottom: 14 }}>
            <div className="row" style={{ gap: 30 }}>
              ...
              <div className="field"><label>所属项目</label><b>{doc.project}</b><span className="newtag">本次新增</span></div>
  ...
  return (
    <>
      ...
      <div className="tbl-wrap">
        <table>
          <thead>
            <tr><th className="tw">差异单号</th><th className="tw col-new w2" data-hl="本次新增">项目</th><th className="tw">来源链路</th><th className="tw">关联供货单</th><th>差异摘要</th><th>异常原因 / 凭证</th><th className="tw">审核结果</th><th className="tw">状态</th><th className="tw">补发任务</th><th className="tw">操作</th></tr>
          </thead>
          <tbody>
            {pgD.pageRows.map((d) => (
              <tr key={d.id}>
            ...
            <div style={{ display: "flex", gap: 24, marginTop: 16 }}>
              <div style={{ flex: 1, border: "1px solid var(--line)", borderRadius: 4, padding: "14px 18px" }}>
                ...
                <div style={{ marginTop: 10, display: "flex", flexDirection: "column", gap: 9, fontSize: 13, color: "var(--text-2)" }}>
                  <div><span className="note">所属项目：</span>{d.project}<span className="newtag">本次新增</span></div>
        ...
        <table className="tbl-tight">
          <thead>
            <tr>
              ...
              <th className="tw col-new w2" data-hl="本次新增">项目</th>
          ...
          <tbody>
            {pgA.pageRows.map((r, i) => (
              <tr key={r.asNo}>
                ...
                <td className="tw col-new">{r.project}</td>
                <td>
                  <div className="prod-cell">
