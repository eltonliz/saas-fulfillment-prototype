  ...
  return (
    <>
      ...
      <div className="tbl-wrap">
        <table className="tbl-tight">
          <thead>
            <tr><th className="tw">返厂单号</th><th className="tw col-new w2" data-hl="本次新增">项目</th><th className="tw">退货门店</th><th>商品</th><th className="tw">退货数量</th><th className="tw">退货原因</th><th className="tw">金额</th><th className="tw">状态</th><th style={{ minWidth: 92 }}>操作</th></tr>
          </thead>
          <tbody>
            {pgS.pageRows.map((r) => {
